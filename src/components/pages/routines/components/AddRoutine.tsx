...
import { addRoutine } from '../../../../slices/routinesSlice';
...
export const AddRoutine = ({ open, setOpenModalAdd }: { open: boolean, setOpenModalAdd: (open: boolean) => void }) => {
    ...
    const onSubmit = (data: Routine) => {
        data.id = uniqid()
        data.exercises.forEach(exercice => {
            exercice.id = uniqid()
        });
